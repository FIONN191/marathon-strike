...
> 程序化生成的 3D 场景 · 酸性荧光绿 HUD · 红黑棋盘站点 · 安全黄警示条 · 深青虚空星点。

![A 站点对峙：进攻方携带熵核推进，回合开始](docs/screenshots/01-bsite-standoff.png)

![B 站点突破：霓虹站点标识与警示护栏](docs/screenshots/02-bsite-push.png)

![中路交火：弹道曳光与敌方跑者](docs/screenshots/03-firefight.png)
